    ...
    <div class="customer mt-3">
        <ul>
            ...
            @if ($customer->is_paid == 0)
                <li>Ghi chú: <span class="btn btn-danger btn-xs"><strong>CHƯA THANH TOÁN</strong></span></li>
            @else
                <li>Ghi chú: <span class="btn btn-success btn-xs"><strong>ĐÃ THANH TOÁN</strong></span></li>
            @endif
        </ul>
        {{-- <ul>
            <a href="/admin/customers/edit/" class="btn btn-danger btn-xs">NO</a>
        </ul> --}}
    </div>
