...
@section('content')
    <div class="customer mt-3">
        <ul>
            <li>Tổng tiền chi: <strong>{{ $total_price }}</strong></li>
            <li>Tổng tiền thu: <strong>{{ $total_price_sale }}</strong></li>
            <li>Tổng tiền nhận được: <strong>{{ $total_price_get }}</strong></li>
            <li>Số đơn hoàn thành: <strong>{{ $total_bill_paid }}</strong></li>
        </ul>
    </div>
