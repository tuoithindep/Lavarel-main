...
Route::middleware(['auth'])->group(function () {
    ...
    Route::prefix('admin')->group(function () {
        ...
        Route::get('customers/edit/{customer}', [\App\Http\Controllers\Admin\CartController::class, 'update']);
        Route::get('customers/report', [\App\Http\Controllers\Admin\CartController::class, 'report']);

        #Users
        Route::get('users', [UsersController::class, 'index']);
        Route::get('users/add', [UsersController::class, 'create']);
        Route::post('users/add', [UsersController::class, 'store']);
        Route::get('users/edit/{user_id}', [UsersController::class, 'show']);
        Route::post('users/edit/{user_id}', [UsersController::class, 'update']);
